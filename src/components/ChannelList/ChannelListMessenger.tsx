...
const renderItem = ({item, index}) => {
  ...
  useEffect(() => {
    setJoinChannel([...getUniqueListBy(channels, 'id'), ...getUniqueListBy(additionalData, 'activity_id')].sort((a:any, b:any) => new Date(b.data.updated_at).getTime() - new Date(a.data.updated_at).getTime()))
