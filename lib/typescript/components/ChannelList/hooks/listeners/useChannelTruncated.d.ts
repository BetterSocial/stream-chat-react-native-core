...
export declare const useChannelTruncated: <At extends UnknownType = DefaultAttachmentType, Ch extends UnknownType = DefaultChannelType, Co extends string = import("stream-chat").LiteralStringForUnion, Ev extends UnknownType = UnknownType, Me extends UnknownType = UnknownType, Re extends UnknownType = UnknownType, Us extends UnknownType = DefaultUserType>({ onChannelTruncated, refreshList, setChannels, setForceUpdate, }: Parameters<At, Ch, Co, Ev, Me, Re, Us>) => void;
export {};
