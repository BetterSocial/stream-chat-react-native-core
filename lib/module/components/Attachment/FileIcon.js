...
var FileIcon = function FileIcon(_ref) {
  ...
  return _react["default"].createElement(Icon, (0, _extends2["default"])({}, size ? {
    height: size,
    width: size
  } : {}, icon, {
    __self: _this,
