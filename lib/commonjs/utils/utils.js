...
exports.emojiRegex = exports.generateRandomId = exports.vh = exports.vw = exports.getUrlWithoutParams = exports.makeImageCompatibleUrl = exports.ACITriggerSettings = exports.isMentionTrigger = exports.isEmojiTrigger = exports.isCommandTrigger = exports.queryUsersDebounced = exports.queryMembersDebounced = exports.ProgressIndicatorTypes = exports.FileState = void 0;
  ...
  return {
    ...
    ':': {
      ...
      dataProvider: function dataProvider(query, _, onReady) {
        ...
        var result = _compiled.compiledEmojis.emojiArray.reduce(function (acc, cur) {
          if (acc.length >= 10) return acc;

          if (cur.names.some(function (name) {
            return name.includes(query);
          })) {
            var emoji = _compiled.compiledEmojis.emojiLib[cur.name];

            if (emoji.skin_variations) {
              acc.push((0, _extends2["default"])({}, emoji, {
                name: emoji.name + "-tone-1",
                skin_variations: undefined
              }));
              emoji.skin_variations.forEach(function (tone, index) {
                return acc.push((0, _extends2["default"])({}, emoji, {
